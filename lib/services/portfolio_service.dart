...
class PortfolioService {
  ...
  static List<Skill> getSkills() {
    return [
      const Skill(name: 'Flutter', category: SkillCategory.primary, proficiencyLevel: 5, description: '7+ years expertise'),
      const Skill(name: 'Dart', category: SkillCategory.primary, proficiencyLevel: 5, description: '7+ years expertise'),
      const Skill(name: 'Android', category: SkillCategory.primary, proficiencyLevel: 5, description: '8+ years'),
      const Skill(name: 'iOS', category: SkillCategory.primary, proficiencyLevel: 4,  description: '3+ years'),
      const Skill(name: 'Node.js', category: SkillCategory.backend, proficiencyLevel: 4,  description: '2+ years'),
      const Skill(name: 'Firebase', category: SkillCategory.backend, proficiencyLevel: 4,  description: '4+ years'),
      const Skill(name: 'Hasura', category: SkillCategory.backend, proficiencyLevel: 3),
      const Skill(name: 'Cross-platform', category: SkillCategory.specialization, proficiencyLevel: 5),
      const Skill(name: 'App architecture', category: SkillCategory.specialization, proficiencyLevel: 5),
      const Skill(name: 'App scalability', category: SkillCategory.specialization, proficiencyLevel: 5),
      const Skill(name: 'Performance optimization', category: SkillCategory.specialization, proficiencyLevel: 5),
      const Skill(name: 'State management', category: SkillCategory.specialization, proficiencyLevel: 5),
      const Skill(name: 'Package development', category: SkillCategory.specialization, proficiencyLevel: 5),
  ...
  static List<Project> getProjects() {
    return [
      ...
      const Project(
        ...
        description: 'Lead core team to bring upgrade and build new feature. These core features powered other product features in the app. I mandated bug free and stability confidece principles for development under core branch.',
      ...
      const Project(
        ...
        description: 'Loved by the use case of 100ms, I built Flutter plugin for video solutions used by businesses. This plugin became base for integrating 100ms in flutter apps.',
      ...
      const Project(
        ...
        description: 'I worked on on performance and product features. I improved app performance by 70% and helped in improving overall app rating by 30% on stores.',
